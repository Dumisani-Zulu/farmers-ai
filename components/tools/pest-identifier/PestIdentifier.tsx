...
export default function PestIdentifier() {
  ...
  return (
    <View className="flex-1 bg-white p-4">
      <View className="mb-6">
        <Text className="text-2xl font-bold text-gray-900 mb-2">Pest Identifier</Text>
        <Text className="text-gray-600">
          Upload or take a photo to identify pests affecting your crops
        </Text>
      </View>
      ...
      {selectedImage ? (
        ...
        <View className="border-2 border-dashed border-gray-300 rounded-lg p-8 mb-6 items-center">
          <Ionicons name="bug-outline" size={60} color="#9CA3AF" />
      ...
      <TouchableOpacity
        ...
        className={`rounded-lg p-4 items-center ${
          selectedImage && !isAnalyzing ? 'bg-orange-500' : 'bg-gray-300'
        }`}
      >
        {isAnalyzing ? (
          ...
          <>
            ...
            <Text className="text-white font-medium mt-1">Identify Pest</Text>
          </>
        )}
      </TouchableOpacity>
    </View>
